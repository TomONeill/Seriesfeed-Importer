...
module SeriesfeedImporter.Controllers {
    export class XmlFavouriteSelectionController {
        ...
        private initialiseCard(): void {
            ...
            const breadcrumbs = [
                ...
                new Models.Breadcrumb("XML", Enums.ShortUrl.ExportSourceSelection),
                new Models.Breadcrumb("Exporteren", Enums.ShortUrl.ExportXml)
            ];
