...
module SeriesfeedImporter.Controllers {
    export class JsonFavouriteSelectionController {
        ...
        private initialiseCard(): void {
            ...
            const breadcrumbs = [
                ...
                new Models.Breadcrumb("JSON", Enums.ShortUrl.ExportSourceSelection),
                new Models.Breadcrumb("Exporteren", Enums.ShortUrl.ExportJson)
            ];
